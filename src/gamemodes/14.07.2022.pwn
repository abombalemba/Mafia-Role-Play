...
*/
	...
	// mechanic
	VehMechanic[0] = ASVex(525,2100.7144,1409.1077,10.6922,360.0,43,17,600);
	VehMechanic[1] = ASVex(525,2107.1392,1409.1051,10.6989,360.0,43,17,600);
	VehMechanic[2] = ASVex(525,2113.6013,1409.0767,10.7006,360.0,43,17,600);
	VehMechanic[3] = ASVex(525,2119.9688,1409.0902,10.6850,360.0,43,17,600);
	VehMechanic[4] = ASVex(525,2126.3979,1409.1039,10.7001,360.0,43,17,600);
	VehMechanic[5] = ASVex(525,2132.7322,1409.0400,10.6986,360.0,43,17,600);
	
	// trashmaster
	VehTrashmaster[0][tID] = ASVex(408,2295.7302,2738.3870,11.3750,270.0,26,26,600);
	VehTrashmaster[1][tID] = ASVex(408,2295.8091,2747.9150,11.3761,270.0,26,26,600);
	VehTrashmaster[2][tID] = ASVex(408,2295.6865,2754.5466,11.3649,270.0,26,26,600);
	VehTrashmaster[3][tID] = ASVex(408,2295.7483,2763.9771,11.3711,270.0,26,26,600);
	VehTrashmaster[4][tID] = ASVex(408,2295.8491,2770.4812,11.3565,270.0,26,26,600);
	VehTrashmaster[5][tID] = ASVex(408,2295.6516,2780.0242,11.3646,270.0,26,26,600);
	...
	// truck
 	...
 	VehTruck[0] = ASVex(514,282.4,1355.0,11.2,90.0,101,101,600);
 	VehTruck[0] = ASVex(514,282.4,1362.0,11.2,90.0,101,101,600);
 	VehTruck[0] = ASVex(514,282.4,1369.0,11.2,90.0,101,101,600);
 	VehTruck[0] = ASVex(514,282.4,1376.0,11.2,90.0,101,101,600);
 	VehTruck[0] = ASVex(514,282.4,1383.0,11.2,90.0,101,101,600);
	...
	// fire truck
	VehFireTruck[0] = ASVex(407,1770.0,2077.4,11.2,180.0,0,0,600);
	VehFireTruck[0] = ASVex(407,1763.0,2077.4,11.2,180.0,0,0,600);
	VehFireTruck[0] = ASVex(407,1757.0,2077.4,11.2,180.0,0,0,600);
	VehFireTruck[0] = ASVex(407,1750.0,2077.4,11.2,180.0,0,0,600);
	VehFireTruck[0] = ASVex(544,1731.5,2078.0,11.2,270.0,0,0,600);
	VehFireTruck[0] = ASVex(544,1731.5,2070.0,11.2,270.0,0,0,600);
...
static stock Mapping(playerid) {
    CDO(1684, 1595.49316, 2291.25415, 11.47360,   0.00000, 0.00000, 90.00000);
    return 1;
}
...
CMD:cancelrent(playerid) {
	...
	format(string,sizeof(string),"%s Вы успешно отменили аренду транспорта. Техника отбуксирована на стоянку.",PrefixHint);
	SCM(playerid,WHITE,string);
	return 1;
}
...
CMD:setfuelall(playerid,params[])
{
    ...
    if(adminVariable[playerid][aLogged]==false) return SCM(playerid,WHITE,AdmNotAuthorized);
    if(playerVariable[playerid][pAdmin]<1) return SCM(playerid,WHITE,AdmNotAccess);
    if(sscanf(params,"i",params[0])) { format(string,sizeof(string),"%s Используйте: /setfuelall [радиус] [кол-во]",PrefixAdmRed); return SCM(playerid,WHITE,string); }
